...
var cloudMap = null;
var cloudMapUrl = "../images/earthcloudmap.jpg";
var cloudTransparency = null;
var cloudTransparencyUrl = "../images/earthcloudmaptrans.jpg";
...
function createMaterials()
{
    ...
    cloudMap = new THREE.TextureLoader().load(cloudMapUrl);
    cloudTransparency = new THREE.TextureLoader().load(cloudTransparencyUrl);
...
function createScene(canvas) {
    ...
    light = new THREE.AmbientLight ( 0xff2222 );
    root.add(light);
